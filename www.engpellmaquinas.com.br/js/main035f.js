...
function headerCustomizer() {
  ...
  if (!navigator.userAgent.match(/iPad|iPhone|Android/i)) {
	...
	$(window).scroll(function(){
	  ...
	  if ($this.scrollTop() >= headerHeight+350) {
		$(".r_menu").removeClass('add_curva_menu').addClass('remove_curva_menu');
		//$(".r_menu").css('display','none');
		//$(".r_menu").attr('data-appear-animation','fadeOut')
	  } else {
		$(".r_menu").removeClass('remove_curva_menu').addClass('add_curva_menu');		
		//data-appear-animation="fadeInUp"
		//$(".r_menu").attr('data-appear-animation','fadeIn');
		//$(".r_menu").css('display','block')
	  }

...
function revslider_showDoubleJqueryError(e) {
    ...
    e.fn.extend({
        revolution: function(r) {
            ...
            return this.each(function() { /*console.groupCollapsed("Slider Revolution 4.5.7 Initialisation on "+e(this).attr("id"));console.groupCollapsed("Used Options:");console.info(r);console.groupEnd();console.groupCollapsed("Tween Engine:")*/ ;
                if (punchgs.TweenLite == t) { /*console.error("GreenSock Engine Does not Exist!")*/ ;
                    return false
